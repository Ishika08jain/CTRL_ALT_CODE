...
//    public static String ITEM_TITLE="songTitle";
//    public static String ITEM_IMAGE="songImage";
//    public static String FAVORITE_STATUS="fStatus";
//
//
//    private static String CREATE_TABLE="CREATE TABLE"+TABLE_NAME+"("+KEY_ID+"TEXT,"+ FAVORITE_STATUS+"TEXT");
